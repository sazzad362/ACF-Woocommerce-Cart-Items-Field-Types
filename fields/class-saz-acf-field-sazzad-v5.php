...
if( !class_exists('sa_acf_field_sazzad') ) :


class sa_acf_field_sazzad extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('Cart Items', 'Sazzad362');
		...
		*  var message = acf._e('sazzad', 'error');
		*/
           ...
           global $woocommerce;
            echo '<select name="' . esc_attr( $field['name'] ) . '">';
                 $cart = $woocommerce->cart->cart_contents;
                    ...
                    $product_name = $item['data']->parent->post->post_title;
                   // echo "<option value=".esc_attr($product_name).">".$product_name."</option>";
                   ?>
...
// initialize
new sa_acf_field_sazzad( $this->settings );
